...
def main():
    ...
    output_dict = {
        ...
        'WEATHER_HOUR_DATETIME_A': datetime.datetime.fromtimestamp(weather["hourly"][10]["dt"]).strftime("%I %p"),
        ...
        'WEATHER_HOUR_DATETIME_B': datetime.datetime.fromtimestamp(weather["hourly"][11]["dt"]).strftime("%I %p"),
