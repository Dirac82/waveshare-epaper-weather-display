...
def main():
    ...
    output_dict = {
        ...
        'W_HOUR_POP_1': "{}%".format(str(round(weather["hourly"][1]["pop"]))),
        ...
        'W_HOUR_POP_2': "{}%".format(str(round(weather["hourly"][2]["pop"]))),
        ...
        'W_HOUR_POP_3': "{}%".format(str(round(weather["hourly"][3]["pop"]))),
        ...
        'W_HOUR_POP_4': "{}%".format(str(round(weather["hourly"][4]["pop"]))),
        ...
        'W_HOUR_POP_5': "{}%".format(str(round(weather["hourly"][5]["pop"]))),
        ...
        'W_DAY_POP_1': "{}%".format(str(round(weather["daily"][1]["pop"]))),
        ...
        'W_DAY_POP_2': "{}%".format(str(round(weather["daily"][2]["pop"]))),
        ...
        'W_DAY_POP_3': "{}%".format(str(round(weather["daily"][3]["pop"]))),
        ...
        'W_DAY_POP_4': "{}%".format(str(round(weather["daily"][4]["pop"]))),
        ...
        'W_DAY_POP_5': "{}%".format(str(round(weather["daily"][5]["pop"]))),
