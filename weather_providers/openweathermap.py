...
class OpenWeatherMap(BaseWeatherProvider):
    ...
    def get_url(self):
        url = ("https://api.openweathermap.org/data/3.0/onecall?lat={}&lon={}&exclude=minutely&units={}&appid={}&lang=de"
    ...
    def get_hourly_forecast(self):
        ...
        for hour_entry in weather_data:
            ...
            entry["wind_direction"] = self.wind_deg2txt(hour_entry["wind_deg"])
